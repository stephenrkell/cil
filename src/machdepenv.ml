...
let modelParse (s:string) : mach =
  ...
  in
  {
    ...
    have_float16x = getBool entries "have_float16x";
    sizeof_float16x = getSizeof entries "float16x";
    alignof_float16x = getAlignof entries "float16x";
    have_float16complex = getBool entries "have_float16complex";
    ...
    sizeof_float32 = getSizeof entries "float32";
    alignof_float32 = getAlignof entries "float32";
    ...
    sizeof_float64 = getSizeof entries "float64";
    alignof_float64 = getAlignof entries "float64";
    ...
    have_float128x = getBool entries "have_float128x";
    sizeof_float128x = getSizeof entries "float128x";
    alignof_float128x = getAlignof entries "float128x";
    have_float128complex = getBool entries "have_float128complex";
    sizeof_float128complex = getSizeof entries "float128_complex";
    alignof_float128complex = getAlignof entries "float128_complex";  
    have_floatcomplex = getBool entries "have_floatcomplex";
