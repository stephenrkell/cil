...
let modelParse (s:string) : mach = 
  ...
  in
  {
    ...
    sizeof_shortfloat = getSizeof entries "shortfloat";
    alignof_shortfloat = getAlignof entries "shortfloat";
    ...
    alignof___float128 = getInt entries "alignof___float128";
    alignof_float128 = getInt entries "alignof_float128";
    alignof_float128x = getInt entries "alignof_float128x";
    alignof_float64x = getInt entries "alignof_float64x";
    alignof_float32x = getInt entries "alignof_float32x";
    alignof_float16x = getInt entries "alignof_float16x";
    alignof_float64 = getInt entries "alignof_float64";
    alignof_float32 =  getInt entries "alignof_float32";
    alignof_float16 = getInt entries "alignof_float16";
    sizeof_complex_shortfloat = getSizeof entries "shortfloatcomplex";
    alignof_complex_shortfloat = getAlignof entries "shortfloatcomplex";
    sizeof_complex_float = getSizeof entries "floatcomplex";
    alignof_complex_float = getAlignof entries "floatcomplex";
    sizeof_complex_double = getSizeof entries "doublecomplex";
    alignof_complex_double = getAlignof entries "doublecomplex";
    sizeof_complex_longdouble = getSizeof entries "long_doublecomplex";
    alignof_complex_longdouble = getAlignof entries "long_doublecomplex";
    alignof_complex_float128 = getInt entries "alignof_complex_float128";
    alignof_complex_float128x = getInt entries "alignof_complex_float128x";
    alignof_complex_float64x = getInt entries "alignof_complex_float64x";
    alignof_complex_float32x = getInt entries "alignof_complex_float32x";
    alignof_complex_float16x = getInt entries "alignof_complex_float16x";
