...
type mach = {
  ...
  sizeof_float16x: int;   (* Size of "_Float16x" *)
  sizeof_float32: int;   (* Size of "_Float32" *)
  sizeof_float32x: int;   (* Size of "_Float32x" *)
  sizeof_float64: int;   (* Size of "_Float64" *)
  sizeof_float64x: int;   (* Size of "_Float64x" *)
  sizeof_float128: int;   (* Size of "_Float128" *)
  sizeof_float128x: int;   (* Size of "_Float128x" *)
  ...
  alignof_float16x: int;  (* Alignment of "_Float16x" *)
  alignof_float32: int;  (* Alignment of "_Float32" *)
  alignof_float32x: int;  (* Alignment of "_Float32x" *)
  alignof_float64: int;  (* Alignment of "_Float64" *)
  alignof_float64x: int;  (* Alignment of "_Float64x" *)
  alignof_float128: int;  (* Alignment of "_Float128" *)
  alignof_float128x: int;  (* Alignment of "_Float128x" *)
  ...
  have_float16x: bool; (* Whether _Float16x is supported. *)
  have_float16complex: bool; (* Whether _Float16 _Complex is supported. *)
  ...
  have_float128x: bool; (* Whether _Float128x is supported. *)
  have_float128complex: bool; (* Whether _Float128 _Complex is supported. *)
  have_floatcomplex: bool; (* Whether float _Complex is supported. *)
}
